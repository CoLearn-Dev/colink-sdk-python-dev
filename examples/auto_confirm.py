...
from colink.sdk_a import Dds, get_timestamp
...
if __name__ == "__main__":
    ...
    if res is not None:
        ...
        list_ = colink_pb2.CoLinkInternalTaskIDList().FromString(
            list_entry.payload
        )  # parse dds proto struct from binary
    ...
    queue_name = dds.subscribe(latest_key, start_timestamp)
    ...
    while True:
        ...
        if message.change_type != "delete":
            ...
            if task.status == "waiting":
                dds.confirm_task(task_id.task_id, True, False, "")
